        ...
        <div className="w-main h-[88px] py-[20px] flex justify-between ">
          ...
          <div className="flex bg-white items-center w-1/2  md:w-1/3 rounded">
            <div className="flex relative w-full">
              <input onChange={(event) => setSearch(event.target.value)} className="w-[85%] m-2 focus:outline-none border:none" placeholder="Tìm kiếm sản phẩm"/>
              <button onClick={handleSearch} className="w-[15%] flex  justify-center absolute right-0 top-[12px]">
                <BiSearch />
              </button>
            </div>
          </div>
